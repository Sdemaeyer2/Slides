...
knitr::include_graphics(here("C1", "Fig" ,"Golem.jpg"))
```
]
...
knitr::include_graphics(here("C1", "Fig" ,"Robot1.jpg"))
```
]
...
knitr::include_graphics(here("C1", "Fig" ,"Robot2.jpg"))
```
]
...
```{r, out.height = "50%", out.width="50%", eval = T, echo = F}
knitr::include_graphics(here("C1", "Fig" ,"Analysemod1.png"))
```
...
```{r, out.height = "50%", out.width="50%", eval = T, echo = F}
knitr::include_graphics(here("C1", "Fig" ,"Analysemod2.png"))
```
...
knitr::include_graphics(here("C1", "Fig" ,"assumpties.jpg"))
```
